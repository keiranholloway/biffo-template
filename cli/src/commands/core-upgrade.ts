 ...
 * direct push to a protected branch. The commit this writes touches only
 * template-owned paths; later commits pushed to the same branch are ordinary
 * reviewable changes and are not, which is what the PR body now says (#1999).
 */
