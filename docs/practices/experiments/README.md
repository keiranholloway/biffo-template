...
| [H7](H7-fail-open-authoring-gate.md) | Asking the fail-open question at authoring time reduces newly-created `fail-open` entries | new fail-open corpus entries per merged PR 0.078 → lower | `inconclusive` | 2026-09-01 | reviewed 2026-09-08; corpus dark since 2026-08-10, re-review after recording resumes |
