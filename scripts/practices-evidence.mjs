 ...
 * `practices-evidence.test.mjs` — a stale table now fails CI instead of being
...
export function tallyMarkdown(rows) {
  ...
  const lines = [
    TALLY_BEGIN,
    '',
    `_Generated by \`node scripts/practices-evidence.mjs --write\` from **${total}** rows in \`docs/practices/evidence.jsonl\`. Do not edit between the markers — \`practices-evidence.test.mjs\` fails when this block does not match the dataset._`,
    '',
